...
<div class="wrap wpProQuiz_questionOverall">
	...
	<p>
		...
		<?php if(current_user_can('wpProQuiz_edit_quiz')) { ?>
			<a class="button-secondary" href="admin.php?page=ldAdvQuiz&action=edit&id=<?php echo $this->quiz->getId(); ?>"><?php _e('Edit quiz', 'wp-pro-quiz'); ?></a> 
		<?php } ?>
	</p>
			...
			<tr id="wpProQuiz_questionId_<?php echo $question->getId(); ?>">
				...
				<td>
					...
					<div class="row-actions">
						<?php if(current_user_can('wpProQuiz_edit_quiz')) { ?>
						<span>
							<a href="admin.php?page=ldAdvQuiz&module=question&action=edit&quiz_id=<?php echo $this->quiz->getId(); ?>&id=<?php echo $question->getId(); ?>"><?php _e('Edit', 'wp-pro-quiz'); ?></a> | 
						</span>
	...
	<p>
		<?php if(current_user_can('wpProQuiz_edit_quiz')) { ?>
		<a class="button-secondary" href="admin.php?page=ldAdvQuiz&module=question&action=add&quiz_id=<?php echo $this->quiz->getId(); ?>"><?php _e('Add question', 'wp-pro-quiz'); ?></a>
