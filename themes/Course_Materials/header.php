...
if (apply_filters('thematic_open_wrapper', true)) {
    ...
    <div id="header">
    <!-- Insert TOP BAR images and links. -->    
   	<div id="topbar"> 
    <a id="cns" class="right" href="http://cns.utexas.edu" title="College of Natural Sciences"></a>  
    <a id="utaustin" href="http://www.utexas.edu/" title="The University of Texas at Austin"></a> 
    </div> 
    <!-- / TOP BAR --> 
